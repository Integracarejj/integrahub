            ...
            <form onSubmit={handleSubmit} className="create-form">
                ...
                <div className="form-section">
                    ...
                    <div className="form-grid">
                        ...
                        <div className="form-field">
                            <label htmlFor="reportingSource">Reporting Source
                                <span className="field-tooltip" data-tooltip="Indicates the origin of reports generated by the system, such as an internal data warehouse, vendor reporting module, or BI tool.">ⓘ</span>
                            </label>
                            <select
                                id="reportingSource"

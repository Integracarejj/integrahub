...
export interface RecapRequest {
    ...
    owner: string | null;
    team: string;
    status: "Queued" | "Provided" | "In Progress" | "Returned for Changes" | "Needs DD Review" | "Ready to Publish" | "Clarification Needed" | "Under Review" | "Open" | "Assigned" | "Overdue" | "Pending External" | "Blocked" | "Ready for Review" | "Complete" | "Not Applicable" | "Duplicate" | "Rejected" | "Waiting Partner Review" | "Completed" | "Needs Rework";
...
export interface ExternalMessageEntry {
    id: string;
    text: string;
    author: string;
    timestamp: string;
...
const MOCK_REQUESTS: RecapRequest[] = [
    { id: "req-001", requestId: "DD-26-001", intakeId: "INT-26-1", transactionId: "txn-valstone", transactionName: "Valstone Corp Portfolio", brokerBuyer: "Marcus & Assoc / Valstone Corp", communityIds: ["comm-vg"], communityNames: ["Valencia Grove"], category: "Financial Statements", title: "Audited financials for Valencia Grove (FY 2024-2025)", description: "Request audited financial statements for Valencia Grove covering fiscal years 2024 and 2025, including balance sheet, income statement, and cash flow.", owner: "Sarah Chen", team: "Financial Analysis", status: "Provided", priority: "High", dueDate: "2026-07-15", lastUpdated: "2026-06-20", externalVisible: true, submittedBy: "Marcus & Associates", source: "External", createdDate: "2026-05-10", assignedTo: "Sarah Chen", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-002", requestId: "DD-26-002", intakeId: "INT-26-2", transactionId: "txn-valstone", transactionName: "Valstone Corp Portfolio", brokerBuyer: "Marcus & Assoc / Valstone Corp", communityIds: ["comm-om"], communityNames: ["Oakwood Manor"], category: "Licenses", title: "Oakwood Manor state licensing and certifications", description: "Current state licenses, Medicare/Medicaid certifications, and any recent survey results for Oakwood Manor.", owner: "James Wright", team: "Regulatory", status: "In Progress", priority: "High", dueDate: "2026-07-20", lastUpdated: "2026-06-22", externalVisible: true, submittedBy: "Marcus & Associates", source: "External", createdDate: "2026-05-12", assignedTo: "James Wright", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-003", requestId: "DD-26-003", intakeId: "INT-26-3", transactionId: "txn-valstone", transactionName: "Valstone Corp Portfolio", brokerBuyer: "Marcus & Assoc / Valstone Corp", communityIds: ["comm-sb", "comm-pv"], communityNames: ["Sunset Bay", "Palm Vista"], category: "Environmental", title: "Phase I environmental reports for Sunset Bay and Palm Vista", description: "Phase I environmental site assessment reports for both Sunset Bay and Palm Vista properties.", owner: "Lisa Park", team: "Environmental", status: "Clarification Needed", priority: "Medium", dueDate: "2026-07-10", lastUpdated: "2026-06-21", externalVisible: true, submittedBy: "Marcus & Associates", source: "External", createdDate: "2026-05-14", assignedTo: "Lisa Park", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-004", requestId: "DD-26-004", intakeId: "INT-26-4", transactionId: "txn-valstone", transactionName: "Valstone Corp Portfolio", brokerBuyer: "Marcus & Assoc / Valstone Corp", communityIds: [], communityNames: ["All Communities"], category: "Insurance", title: "Portfolio-wide general liability and professional liability coverage", description: "Certificates of insurance for all 8 Valstone properties - general liability, professional liability, workers comp, and property insurance.", owner: "Tom Davies", team: "Risk Management", status: "Under Review", priority: "High", dueDate: "2026-07-25", lastUpdated: "2026-06-23", externalVisible: false, submittedBy: "Internal DD Team", source: "Internal", createdDate: "2026-05-08", assignedTo: "Tom Davies", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-005", requestId: "DD-26-005", intakeId: "INT-26-5", transactionId: "txn-valstone", transactionName: "Valstone Corp Portfolio", brokerBuyer: "Marcus & Assoc / Valstone Corp", communityIds: ["comm-hc"], communityNames: ["Harbor Cove"], category: "Financial Statements", title: "Harbor Cove rent rolls and occupancy reports (last 12 months)", description: "Monthly rent rolls, delinquency reports, and occupancy data for Harbor Cove covering the most recent 12-month period.", owner: "Sarah Chen", team: "Financial Analysis", status: "Complete", priority: "Medium", dueDate: "2026-07-05", lastUpdated: "2026-06-18", externalVisible: true, submittedBy: "Marcus & Associates", source: "External", createdDate: "2026-05-20", assignedTo: "Sarah Chen", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Ready to Publish" },
    { id: "req-006", requestId: "DD-26-006", intakeId: "INT-26-6", transactionId: "txn-valstone", transactionName: "Valstone Corp Portfolio", brokerBuyer: "Marcus & Assoc / Valstone Corp", communityIds: ["comm-mp", "comm-cr", "comm-bb"], communityNames: ["Magnolia Place", "Cedar Ridge", "Bayou Bend"], category: "HR / Staffing", title: "Staffing rosters and labor cost reports for 3 Gulf Coast properties", description: "Full staffing roster, wage rates, turnover data, and labor cost breakdowns for Magnolia Place, Cedar Ridge, and Bayou Bend.", owner: null, team: "HR & Operations", status: "Complete", priority: "Medium", dueDate: "2026-08-01", lastUpdated: "2026-06-10", externalVisible: true, submittedBy: "Marcus & Associates", source: "External", createdDate: "2026-06-01", assignedTo: null, _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-007", requestId: "DD-26-007", intakeId: "INT-26-7", transactionId: "txn-midwest", transactionName: "IntegraCare Midwest", brokerBuyer: "HealthCap / IntegraCare Health", communityIds: ["comm-mw"], communityNames: ["Midwest Region"], category: "Financial Statements", title: "IntegraCare Midwest financial statements FY 2024", description: "Audited financial statements for the Midwest region, including facility-level P&L statements.", owner: "Mike O'Brien", team: "Financial Analysis", status: "Provided", priority: "High", dueDate: "2026-07-01", lastUpdated: "2026-06-19", externalVisible: true, submittedBy: "HealthCap Advisors", source: "External", createdDate: "2026-04-15", assignedTo: "Mike O'Brien", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-008", requestId: "DD-26-008", intakeId: "INT-26-8", transactionId: "txn-midwest", transactionName: "IntegraCare Midwest", brokerBuyer: "HealthCap / IntegraCare Health", communityIds: ["comm-mw"], communityNames: ["Midwest Region"], category: "Regulatory", title: "State survey results and plans of correction", description: "Most recent state survey results, plans of correction, and any enforcement actions for all 3 facilities.", owner: "James Wright", team: "Regulatory", status: "Overdue", priority: "High", dueDate: "2026-06-15", lastUpdated: "2026-06-25", externalVisible: true, submittedBy: "HealthCap Advisors", source: "External", createdDate: "2026-05-01", assignedTo: "James Wright", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-009", requestId: "DD-26-009", intakeId: "INT-26-9", transactionId: "txn-sunshine", transactionName: "Sunshine Healthcare", brokerBuyer: "SLP / Sunshine Health", communityIds: ["comm-sp"], communityNames: ["Sunshine Properties"], category: "Physical Plant", title: "Property condition assessments for all Sunshine facilities", description: "Recent property condition assessments, capital expenditure plans, and deferred maintenance reports.", owner: "Lisa Park", team: "Environmental", status: "In Progress", priority: "Medium", dueDate: "2026-08-10", lastUpdated: "2026-06-24", externalVisible: true, submittedBy: "Senior Living Partners", source: "External", createdDate: "2026-05-25", assignedTo: "Lisa Park", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-010", requestId: "DD-26-010", intakeId: "INT-26-10", transactionId: "txn-valstone", transactionName: "Valstone Corp Portfolio", brokerBuyer: "Marcus & Assoc / Valstone Corp", communityIds: [], communityNames: ["All Communities"], category: "Legal", title: "Pending litigation summary for Valstone portfolio", description: "Summary of any pending or threatened litigation, arbitration, or regulatory proceedings involving any Valstone property.", owner: "Tom Davies", team: "Risk Management", status: "Overdue", priority: "High", dueDate: "2026-06-01", lastUpdated: "2026-06-26", externalVisible: false, submittedBy: "Internal DD Team", source: "Internal", createdDate: "2026-04-20", assignedTo: "Tom Davies", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-011", requestId: "DD-26-011", intakeId: "INT-26-11", transactionId: "txn-valstone", transactionName: "Valstone Corp Portfolio", brokerBuyer: "Marcus & Assoc / Valstone Corp", communityIds: ["comm-vg", "comm-om"], communityNames: ["Valencia Grove", "Oakwood Manor"], category: "Financial Statements", title: "Valencia Grove and Oakwood Manor 3-year revenue trends", description: "Revenue trend analysis for Valencia Grove and Oakwood Manor showing payer mix changes over the past 3 years.", owner: "Sarah Chen", team: "Financial Analysis", status: "Complete", priority: "Medium", dueDate: "2026-07-30", lastUpdated: "2026-06-22", externalVisible: true, submittedBy: "Marcus & Associates", source: "External", createdDate: "2026-06-05", assignedTo: "Sarah Chen", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Ready to Publish" },
    { id: "req-012", requestId: "DD-26-012", intakeId: "INT-26-12", transactionId: "txn-sunshine", transactionName: "Sunshine Healthcare", brokerBuyer: "SLP / Sunshine Health", communityIds: ["comm-sp"], communityNames: ["Sunshine Properties"], category: "Insurance", title: "Sunshine Healthcare liability insurance renewal details", description: "Current insurance policies, renewal terms, and claims history for the Sunshine portfolio.", owner: "Tom Davies", team: "Risk Management", status: "Open", priority: "Low", dueDate: "2026-09-01", lastUpdated: "2026-06-15", externalVisible: false, submittedBy: "Internal DD Team", source: "Internal", createdDate: "2026-06-10", assignedTo: "Tom Davies", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-013", requestId: "DD-26-013", intakeId: "INT-26-13", transactionId: "txn-valstone", transactionName: "Valstone Corp Portfolio", brokerBuyer: "Marcus & Assoc / Valstone Corp", communityIds: ["comm-hc", "comm-mp"], communityNames: ["Harbor Cove", "Magnolia Place"], category: "Operations", title: "Community contact lists for Harbor Cove and Magnolia Place", description: "Emergency contact rosters, key personnel directories, and community referral contact lists for both properties.", owner: "Anna Patel", team: "HR & Operations", status: "Open", priority: "Medium", dueDate: "2026-08-15", lastUpdated: "2026-06-28", externalVisible: true, submittedBy: "Marcus & Associates", source: "External", createdDate: "2026-06-20", assignedTo: "Anna Patel", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-014", requestId: "DD-26-014", intakeId: "INT-26-14", transactionId: "txn-valstone", transactionName: "Valstone Corp Portfolio", brokerBuyer: "Marcus & Assoc / Valstone Corp", communityIds: ["comm-vg", "comm-om", "comm-sb"], communityNames: ["Valencia Grove", "Oakwood Manor", "Sunset Bay"], category: "Operations", title: "Vendor and service agreements for 3 Valstone properties", description: "Copies of all active vendor agreements including food service, therapy, janitorial, maintenance, and landscaping contracts for Valencia Grove, Oakwood Manor, and Sunset Bay.", owner: "Tom Davies", team: "Risk Management", status: "Open", priority: "High", dueDate: "2026-08-01", lastUpdated: "2026-06-27", externalVisible: true, submittedBy: "Marcus & Associates", source: "External", createdDate: "2026-06-18", assignedTo: "Tom Davies", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-015", requestId: "DD-26-015", intakeId: "INT-26-15", transactionId: "txn-sunshine", transactionName: "Sunshine Healthcare", brokerBuyer: "SLP / Sunshine Health", communityIds: ["comm-sp"], communityNames: ["Sunshine Properties"], category: "Marketing", title: "Market analysis and competitive positioning for Sunshine facilities", description: "Market study including competitor analysis, demographic trends, payer mix projections, and occupancy benchmarks for the Sunshine properties market area.", owner: "Carlos Rivera", team: "Financial Analysis", status: "In Progress", priority: "Medium", dueDate: "2026-08-20", lastUpdated: "2026-06-29", externalVisible: true, submittedBy: "Senior Living Partners", source: "External", createdDate: "2026-06-15", assignedTo: "Carlos Rivera", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-016", requestId: "DD-26-016", intakeId: "INT-26-16", transactionId: "txn-valstone", transactionName: "Valstone Corp Portfolio", brokerBuyer: "Marcus & Assoc / Valstone Corp", communityIds: ["comm-pv", "comm-bb"], communityNames: ["Palm Vista", "Bayou Bend"], category: "Insurance", title: "Workers compensation and property insurance for Palm Vista and Bayou Bend", description: "Current workers compensation experience mod ratings, property insurance schedules, and loss run reports for Palm Vista and Bayou Bend.", owner: "Tom Davies", team: "Risk Management", status: "Clarification Needed", priority: "High", dueDate: "2026-07-25", lastUpdated: "2026-06-30", externalVisible: true, submittedBy: "Marcus & Associates", source: "External", createdDate: "2026-06-12", assignedTo: "Tom Davies", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
    { id: "req-017", requestId: "DD-26-017", intakeId: "INT-26-17", transactionId: "txn-valstone", transactionName: "Valstone Corp Portfolio", brokerBuyer: "Marcus & Assoc / Valstone Corp", communityIds: ["comm-cr"], communityNames: ["Cedar Ridge"], category: "Operations", title: "Emergency evacuation plans and disaster preparedness for Cedar Ridge", description: "Current evacuation plans, disaster preparedness protocols, FEMA compliance documentation, and emergency contact rosters for Cedar Ridge.", owner: null, team: "HR & Operations", status: "Complete", priority: "Medium", dueDate: "2026-09-01", lastUpdated: "2026-06-25", externalVisible: true, submittedBy: "Marcus & Associates", source: "External", createdDate: "2026-06-22", assignedTo: null, _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Published External" },
    { id: "req-018", requestId: "DD-26-018", intakeId: "INT-26-18", transactionId: "txn-midwest", transactionName: "IntegraCare Midwest", brokerBuyer: "HealthCap / IntegraCare Health", communityIds: ["comm-mw"], communityNames: ["Midwest Region"], category: "Financial Statements", title: "IntegraCare Midwest trailing 12-month P&L by facility", description: "Trailing twelve months profit and loss statements for each of the 3 Midwest facilities, broken down by revenue center and expense category.", owner: "Mike O'Brien", team: "Financial Analysis", status: "Provided", priority: "High", dueDate: "2026-07-10", lastUpdated: "2026-07-01", externalVisible: true, submittedBy: "HealthCap Advisors", source: "External", createdDate: "2026-06-05", assignedTo: "Mike O'Brien", _publishedAt: "2026-06-01", _createdFromReview: true, _externalStatus: "Internal Only" },
];
...
const MOCK_INTAKE_ITEMS: RecapIntakeItem[] = [
    ...
    },
    {
        ...
        status: "Awaiting Review",
        title: "Insurance coverage limits for DD-26-004 need clarification",

...
| IQ-010 | Recap MVP completion | Recapitalization | MVP BLOCKER | P0 | In Progress | September 2026 | Complete the frozen, durable workflow from external intake through authoritative approval. | Big Rock 1 done. Big Rock 2A backend/schema foundation done. Big Rock 2B authoritative internal frontend done. Remaining plan: publication/published-document contract; partner decision/rework; security/API hardening; production acceptance. Contract: `docs/recap-mvp-contract.md`. |
